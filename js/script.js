...
monogatari.script ({
	...
	'Start':[
		...
		'Introduction': [
			...
			'n Ah... there you are, {{player.name}}.',
			'n I’ve been waiting for you. I know that you’ve been doing wonderfully at Carleton.',
			'n Your curiosity and sense of justice have not gone unnoticed.',
			'n Now, I have a special mission for you.',
			'n There are students around you — just like you — who are struggling to find safe, fair housing.',
			'n Some are being asked for unfair deposits, others face strange clauses in their leases.',
			'n They need someone who can listen, question, and protect them.',
			'n That someone... is you.',
			'n Your task is to help these students identify the red flags in their rental situations.',
			'n Use your logic, your empathy, and your knowledge to make the right decisions.',
